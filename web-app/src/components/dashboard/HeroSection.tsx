  ...
  return (
    <div className="hero-viewport">
      ...
      <div className="hero-hud-overlay">
        <div style={{ padding: '30px 50px', pointerEvents: 'auto' }}>
          <h2 style={{ fontSize: '1.2rem', color: '#94a3b8', fontWeight: 600, marginBottom: '2px' }}>Tổng quan trực tiếp,</h2>
          <h1 style={{ fontSize: '3.4rem', color: '#1e293b', fontWeight: 950, letterSpacing: '-1.8px', margin: 0, textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '12px' }}>
            TRONG NGÀY! <span style={{ color: 'var(--accent)', fontSize: '2.2rem', display: 'inline-block', transform: 'translateY(-4px)' }}>📡</span>
          </h1>
        </div>

        {/* LEFT WIDGETS */}
        <div className="widget" style={{ top: '160px', left: '70px', width: '300px', flexDirection: 'column', alignItems: 'flex-start', pointerEvents: 'auto', animationDelay: '0s' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '16px' }}>
            <Video size={16} color="var(--accent)" />
            <span className="metric-label">Tín hiệu Stream</span>
          </div>
          <div style={{ width: '100%', height: '80px' }}>
            <svg viewBox="0 0 100 40" width="100%" preserveAspectRatio="xMidYMid meet">
        ...
        <div className="widget" style={{ top: '380px', left: '50px', width: '300px', minHeight: '140px', padding: '28px', flexDirection: 'column', alignItems: 'stretch', pointerEvents: 'auto', animationDelay: '-1s' }}>
          ...
          <div style={{ width: '100%', height: '30px' }}>
            <svg viewBox="0 0 100 25" width="100%" preserveAspectRatio="xMidYMid meet">
              <path d="M0,12.5 C20,-2.5 40,-2.5 60,12.5 S80,27.5 100,12.5" fill="none" stroke="var(--danger)" strokeWidth="2.5" strokeLinecap="round" />
            </svg>
          </div>
        </div>

        <div className="widget mini-widget" style={{ top: '600px', left: '100px', gap: '14px', pointerEvents: 'auto', animationDelay: '-2.5s' }}>
        ...
        {/* RIGHT WIDGETS */}
        <div className="widget pill-widget" style={{ top: '150px', right: '110px', gap: '14px', pointerEvents: 'auto', animationDelay: '-0.5s' }}>
        ...
        <div className="widget" style={{ top: '280px', right: '50px', width: '240px', flexDirection: 'column', alignItems: 'stretch', pointerEvents: 'auto', animationDelay: '-1.5s' }}>
        ...
        <div className="widget" style={{ top: '530px', right: '100px', width: '310px', flexDirection: 'column', alignItems: 'stretch', pointerEvents: 'auto', animationDelay: '-2s' }}>
